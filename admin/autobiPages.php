...
// Copy from education
 $useTable="autobiPages";

?>
<div style="width:70%; height:87%; margin:auto; ">
    ...
    <table width="100%">
      <tbody>      
        ...
        <tr class="cent">
          ...
          <td>
            <input type="text" name="phase[]" style="width:50px; height:100px;" value="<?=$r['phase'];?>">
          </td>
         <!-- <td class="contentBox">
            <input type="text" name="content[]" style="height:100px;" value="<?=$r['content'];?>">
          </td> -->
